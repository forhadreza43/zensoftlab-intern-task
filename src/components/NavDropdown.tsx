...
const NavDropdown = ({
   ...
   const closeDropdown = () => {
      closeTimeoutRef.current = window.setTimeout(() => setIsOpen(false), 80);
   };
   ...
   return (
      ...
      >
         <a href={url}>
            <button
               ref={buttonRef}
               className={`h-full flex items-center px-3 gap-1 text-sm font-medium text-primary-foreground transition-colors ${
                              ...
                              <ul>
                                 {column.items.map((item) => (
                                    <li key={item?.name}>
                                       <a
                                          href={item?.url}
                                          className="group flex justify-between items-center p-2 rounded-md hover:bg-gray-200 transition-all duration-300"
                                       >
